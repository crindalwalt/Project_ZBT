    ...
    <div class="inner">
        <div class="content-item-content">
            ...
            <div class="rbt-default-sidebar-wrapper">
                ...
                <nav class="mainmenu-nav">
                    <ul class="dashboard-mainmenu rbt-default-sidebar-list">
                        ...
                        <li><a href="instructor-enrolled-courses.html"><i
                                    class="feather-book-open"></i><span>Enrolled Courses</span></a>
                        </li>
                        ...
                        <li><a href="instructor-my-quiz-attempts.html"><i
                                    class="feather-help-circle"></i><span>My Quiz Attempts</span></a>
                        </li>
                ...
                <nav class="mainmenu-nav">
                    <ul class="dashboard-mainmenu rbt-default-sidebar-list">
                        <li><a href="{{ route("admin.courses") }}"><i class="feather-monitor"></i><span>Courses</span></a>
                        </li>
                        <li>
                        ...
                        <li><a href="{{ route("admin.product.create") }}"><i
                                    class="feather-list"></i><span>Add Product</span></a>
                        </li>
                    </ul>
                </nav>
