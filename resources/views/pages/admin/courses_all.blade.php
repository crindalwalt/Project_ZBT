                                                        ...
                                                        <div class="rbt-card-body">
                                                            <div class="rbt-card-top">
                                                                <div class="rbt-review">
                                                                    ...
                                                                    <li class="rating-count"><i class="feather-globe"></i><span class="ms-2">{{$item->language}}</span></li>
                                                                </div>
                                                                <div class="rbt-bookmark-btn">
                                                                    <a class="rbt-round-btn" title="view this course" href="{{ route("course.detail",$item->slug) }}    "><i class="feather-eye"></i></a>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="rbt-card-bottom">
                                                                ...
                                                                <div class="d-flex justify-content-center align-items-center">
                                                                    <a class="rbt-btn-link left-icon" href="{{ route("admin.course.edit",$item->slug) }}"><i class="feather-edit"></i> Edit</a>
                                                                    <a class="rbt-btn-link left-icon ms-2" href="{{ route("admin.course.destroy",$item->slug) }}"><i class="feather-delete"></i> Delete</a>
