                                            ...
                                            <div class="accordion-body card-body">
                                                ...
                                                <div class="rbt-course-field-wrapper rbt-default-form">
                                                    ...
                                                    <div class="course-field mb--15">
                                                        ...
                                                        <textarea id="editor" rows="50" name="description">
                                                            {{ $product->description }}
                                                        </textarea>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="course-field mb--15">
                                                                                ...
                                                                                <input id="regularPrice-1" type="number"
                                                                                       placeholder="$ Regular Price" name="regular_price" value="{{$product->regular_price}}">
                                                    ...
                                                    <div class="course-field mb--15">
                                                        ...
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" @if($product->status == "active")checked @endif name="status" value="active">
