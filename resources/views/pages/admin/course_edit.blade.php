                                                                    ...
                                                                    <div class="tab-content">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="course-field mb--15">
                                                                                ...
                                                                                <small class="d-block mt_dec--5"><i
                                                                                        class="feather-info"></i> The
                                                                                    Course
                                                                                    Price Includes Your Author
                                                                                    Fee.</small>
                                                                                @error("regular_price")
                                                                                <small class="d-block mt_dec--5"><i
                                                    ...
                                                    {{-- Stripe course price_id --}}
                                                        <div class="course-field mb--15">
                                                            ...
                                                            <input id="field-1" type="text" placeholder="Price_id from Stripe"
                                                                   name="price_id" value="{{$course->price_id}}">
                                                            <small class="d-block mt_dec--5"><i
                                        ...
                                        <div id="accCollapseTwo" class="accordion-collapse collapse"
                                            ...
                                            <div
                                                ...
                                                <div class="course-field mb--15">
                                                    ...
                                                    <input id="videoUrl" type="text" value="{{$course->video}}"
                                                           name="video">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="course-field mb--15">
                                                        ...
                                                        <div class="row row--15">
                                                            <div class="col-lg-12">
                                                                <input type="number" placeholder="00" name="duration"
