                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-inner text-center">
                        ...
                        <ul class="page-list">
                            ...
                            <li class="rbt-breadcrumb-item active"><a href="{{ route("products")}}">Products</a></li>
                            <li>
                                <div class="icon-right"><i class="feather-chevron-right"></i></div>
                            </li>
    ...
    <div class="rbt-single-product-area rbt-single-product rbt-section-gap">
        <div class="container">
            <div class="row g-5 row--30 align-items-center">
                <div class="col-lg-6">
                    <div class="thumbnail">
                        <img class="w-100 radius-10" src="{{ asset($product->media[0]->image) }}" alt="Product Images">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="content">
                        ...
                        <div class="product-action mb--20">
                            ...
                            <div class="addto-cart-btn">
                                ...
                                <a class=" ms-3 rbt-btn btn-gradient hover-icon-reverse"
                                    href="{{ route("addtocart", $product->slug) }}">
                                    <span class="icon-reverse-wrapper">
                        ...
                        <ul class="product-feature">
                            ...
                            <li><span>Note: </span> <a href="#">Lorem ipsum dolor sit amet, consectetur adipisicing
                                    elit. Accusamus aut beatae consectetur ea esse facere fuga illum iste itaque maiores
                                    maxime minima perspiciatis quas, quis quisquam, repellat tempore totam
                                    veritatis?</a></li>
                                                        ...
                                                        <div class="single-comment">
                                                            ...
                                                            <div class="comment-inner">
                                                                ...
                                                                <div class="comment-meta">
                                                                    <div class="time-spent">{{ $item->created_at->diffForHumans() }}
                                                                    </div>
                                                                </div>
                    ...
                    <div class="rbt-comment-form mt--50 rbt-shadow-box">
                        ...
                        @if (!auth()->check())
                            ...
                            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                <strong>info: </strong> Only Logged In User can post reviews <a href="/login">Click here
                                    to login</a>
                        ...
                        @else
                            <form class="comment-form-style-1 position-relative"
                                action="{{ route("user.product.review", $product->id) }}" method="POST">
                                @csrf
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="rbt-default-card style-three rbt-hover">
                            <div class="inner">
                                ...
                                <div class="thumbnail">
                                    <a href="single-product.html"><img src="{{ asset($item->media[0]->image) }}"
