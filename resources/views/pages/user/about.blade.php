                    ...
                    <div class="content">
                        <div class="inner text-center">
                            <div class="rbt-new-badge rbt-new-badge-one">
                                <span class="rbt-new-badge-icon">🏆</span>Leader in Quranic Education
                            </div>

                            <h1 class="title">Want to
                                <span class="header-caption">
                                    <span class="cd-headline clip is-full-width">
                                        <span class="cd-words-wrapper">
                                            <b class="is-visible theme-gradient">Learn Quran.</b>
                                            <b class="is-hidden theme-gradient">Understand Quran</b>
                                            <b class="is-hidden theme-gradient">Learn and Speak Arabic</b>
                                        </span>
                                </span>
                                </span>
                            </h1>
                            <p class="description has-medium-font-size mt--20">Zaid Bin Thabit Institute: A Worldwide Beacon of Knowledge, connecting every heart to the Divine Message. Discover the Quran’s wisdom and master the Arabic language
                            </p>
                            <div class="slider-btn rbt-button-group justify-content-center">
                                <a class="rbt-btn btn-gradient hover-icon-reverse" href="{{ route("login") }}">
                ...
                <div class="col-lg-6" data-sal="slide-up" data-sal-duration="700">
                    <div class="inner pl--50 pl_sm--5">
                        <div class="content text-start">
                            <span class="rbt-badge-6 bg-primary-opacity">About ZBT.net</span>
                            <h3 class="title">Here is the Little bit about us.</h3>
                            <p class="description mt--30">At Zaid Bin Thabit Institute, our mission is to inspire the global Muslim community to embrace the true spirit of Islam by understanding the Divine message of the Quran. We believe that the Arabic language is the key to unlocking this wisdom and the medium through which Muslims can unite, transcending cultural and linguistic barriers.

                                Our goal is to bring the entire Muslim nation together through the mastery of Arabic, enabling them to fulfill their sacred duty of bearing witness to the truth before the world—both in word and in action—and to maintain the world order ordained by Allah. We aim to empower Muslims to live out the principles of Islam in all aspects of life, from governance to homemaking, ensuring that every part of society reflects the divine balance that guides our world. By connecting hearts and minds through the language of the Quran, we work collectively towards a unified, just, and spiritually grounded future.
                                </p>

                            <div class="read-more-btn mt--40">
                                <a class="rbt-btn rbt-marquee-btn radius-round btn-gradient" href="/courses">
